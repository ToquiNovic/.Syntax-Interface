...
public class Config_Edit_Tema extends javax.swing.JPanel {

 
    public Config_Edit_Tema() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        add(jButton2, new org.netbeans.lib.awtextra.AbsoluteConstraints(60, 80, 140, 50));

        jButton1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Image/eliminar.png"))); // NOI18N
        jButton1.setBorderPainted(false);
        jButton1.setContentAreaFilled(false);
        add(jButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(640, 80, 200, 50));

        jButton3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Image/consultar.png"))); // NOI18N
        jButton3.setBorderPainted(false);
        jButton3.setContentAreaFilled(false);
        add(jButton3, new org.netbeans.lib.awtextra.AbsoluteConstraints(330, 80, 210, 50));
